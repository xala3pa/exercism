...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    return temperature < 800 and neutrons_emitted > 500 and temperature_neutrons < 500_000
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature_neutrons < lower_bound:
        return "LOW"
    if temperature_neutrons <= upper_bound:
        return "NORMAL"
    return "DANGER"
